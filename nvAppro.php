...
include('nav.php');
            ...
            <div id="page-wrapper">
                <div class="container-fluid" style="background-image: url('gestionn.jpg'); width: 100%;">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">approvisionnement</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                   veuillez ajouter une appro
                                </div>
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <form role="form" method="POST" action="ajouterAppro.php">
                                                ...
                                                <div class="form-group">
                                                     <select class="form-control" aria-label=".form-select-lg example" name="id_f">
                                                       <option selected> fournisseur</option>
                                                    <?php 
                                        require_once("DAO.php");
                                                    $e=DAO::listfourniseur();
                                                    foreach ($e as $k) {
                                                   ?>
                                                    <option value="<?=$k->__getfourniseur('id_f')?>"> <?=$k->__getfourniseur('nom')?></option> 
                                              ...
                                              <?php  } ?></select>
                                                    ...
                                                    <select class="form-control" aria-label=".form-select-lg example" name="ref">
                                                       <option selected> referene</option>
                                                    <?php 
                                        require_once("DAO.php");
                                                    $e=DAO::listproduit();
                                                    foreach ($e as $k) {
