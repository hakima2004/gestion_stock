        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid" style="background-image: url('gestionn.jpg'); ">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">nv fournisseur</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <form role="form" method="POST" action="ajouterf.php">
                                              
                                             
                                                    <input class="form-control" placeholder="Enter text" type="hidden" name="id_f">
